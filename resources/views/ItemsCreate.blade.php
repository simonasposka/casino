...
@section('content')
    <div class="w-full mx-auto lg:flex lg:w-1/2 mt-52">
        <div class="flex flex-col justify-center items-center w-full">
            <h2 class="text-4xl leading-10 tracking-tight font-bold text-gray-900 text-center">Create Item</h2>
            <div class="bg-white shadow-[#e3e3e3] shadow-md mt-5 p-6 w-full max-w-md">
                <form action="/dashboard/items" method="POST">
                    ...
                    <textarea name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 border border-gray-400 focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
