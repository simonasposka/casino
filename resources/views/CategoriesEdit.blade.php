...
@section('content')
    <div class="w-full mx-auto lg:flex lg:w-1/2 mt-52">
        <div class="flex flex-col justify-center items-center w-full">
            <h2 class="text-4xl leading-10 tracking-tight font-bold text-gray-900 text-center">Edit category</h2>
            <div class="bg-white shadow-[#e3e3e3] shadow-md mt-5 p-6 w-full max-w-md">
                <form action="/dashboard/categories/{{ $category->id }}" method="POST">
                    ...
                    <input type="text" name="name" class="mt-1 py-2 px-3 block w-full border border-gray-400 shadow-sm" value="{{ $category->name }}" autofocus>
